...
gulp.task('watch', function () {
  gulp.watch(['./targetFile/*.css'], ['md5', 'reloadHtml']);
  gulp.watch(['./targetFile/*.js'], ['md5', 'reloadHtml']);
  gulp.watch(['./targetFile/*.html'], ['md5','reloadHtml']);
});
//启动服务
...
gulp.task('default', ['md5', 'connect', 'watch']);
